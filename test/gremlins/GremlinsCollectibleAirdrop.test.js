...
/**
 */
describe('GremlinsCollectibleAirdrop', function () {

    const CONTRACT_NAME = 'MockGremlinsCollectibleAirdrop';
    ...
    describe('metadata', function () {
        ...
        it('has a name', async function () {
            expect(await this.contract.name()).to.be.equal(CONTRACT_NAME);
        });
    
        it('has a symbol', async function () {
            expect(await this.contract.symbol()).to.be.equal(CONTRACT_SYMBOL);
        });
    });
